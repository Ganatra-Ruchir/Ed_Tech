      ...
      <div className="flex flex-wrap items-center gap-2 border-b border-zinc-100 px-3 py-2.5">
        <div className="relative">
          <select
            ...
            className="appearance-none rounded-md border border-zinc-200 bg-white py-1.5 pl-2.5 pr-7 text-[12.5px] text-zinc-700 focus:border-[#6b1029]/40 focus:outline-none focus:ring-2 focus:ring-[#6b1029]/10"
          >

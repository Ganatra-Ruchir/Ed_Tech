...
const fieldBase =
  "w-full rounded-md border border-zinc-200 bg-white px-3 py-2 text-sm text-zinc-900 placeholder:text-zinc-400 focus:border-[#6b1029] focus:outline-none focus:ring-2 focus:ring-[#6b1029]/15";
